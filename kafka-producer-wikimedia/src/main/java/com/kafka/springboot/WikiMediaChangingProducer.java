...
@Service
public class WikiMediaChangingProducer {
    private static final Logger LOGGER = LoggerFactory.getLogger(WikiMediaChangingProducer.class);
    private final KafkaTemplate<String,String> kafkaTemplate;

    public WikiMediaChangingProducer(KafkaTemplate<String, String> kafkaTemplate) {
    ...
    public void sendMessage() throws InterruptedException {
        ...
        LOGGER.info(String.format("putting message into broker %s",eventSource));
        eventSource.start();
